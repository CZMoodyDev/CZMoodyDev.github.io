/*
Fireflies by Roman Shumilov: https://codepen.io/shumilov/pen/draMmB?&page=1
*/
...
var colors = [];
colors[2] = [];
colors[2]['background'] = '#001730';
colors[2][1] = 'rgba(173,122,153,';
colors[2][2] = 'rgba(217,240,255,';
colors[2][3] = 'rgba(89,171,227,';
colors[2][4] = 'rgba(80,81,79,';
